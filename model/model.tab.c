...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ALPHANUMERIC = 20,              /* ALPHANUMERIC  */
  YYSYMBOL_STRING = 21,                    /* STRING  */
  YYSYMBOL_YYACCEPT = 22,                  /* $accept  */
  YYSYMBOL_body = 23,                      /* body  */
  YYSYMBOL_structure = 24,                 /* structure  */
  YYSYMBOL_structureBody = 25,             /* structureBody  */
  YYSYMBOL_keyValuePair = 26,              /* keyValuePair  */
  YYSYMBOL_LIST = 27,                      /* LIST  */
  YYSYMBOL_LISTBODY = 28,                  /* LISTBODY  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "MODEL", "NM", "CC",
  "AT", "VC", "VS", "VD", "SS", "LO", "':'", "';'", "','", "'{'", "'}'",
  "'['", "']'", "NUMBER", "ALPHANUMERIC", "STRING", "$accept", "body",
  "structure", "structureBody", "keyValuePair", "LIST", "LISTBODY",
  "VALUE", YY_NULLPTR
};
...
{
      19,    11,     8,   -12,    12,   -12,   -12,     9,    14,    16,
      17,    18,    20,    21,    22,    23,    -4,    24,     4,    25,
      26,    27,    28,    29,    32,    32,   -12,    30,   -12,   -12,
...
{
     -12,   -12,    34,   -12,    15,    13,   -12,    -3
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     2,     3,    16,    17,    36,    41,    42
};
...
{
       8,     9,    10,    11,    12,    13,    14,    15,     5,    39,
      40,     1,    26,     8,     9,    10,    11,    12,    13,    14,
      15,    43,     1,     4,    29,    44,    18,     7,    19,    20,
      21,    27,    22,    23,    24,    25,     6,    28,    37,     0,
      45,     0,     0,    38,    30,    31,    32,    33,    34,    35
};

static const yytype_int8 yycheck[] =
{
       4,     5,     6,     7,     8,     9,    10,    11,     0,    20,
      21,     3,    16,     4,     5,     6,     7,     8,     9,    10,
      11,    14,     3,    12,    20,    18,    12,    15,    12,    12,
      12,    16,    12,    12,    12,    12,     2,    13,    25,    -1,
      43,    -1,    -1,    13,    19,    19,    19,    19,    19,    17
};
...
{
       0,     3,    23,    24,    12,     0,    24,    15,     4,     5,
       6,     7,     8,     9,    10,    11,    25,    26,    12,    12,
      12,    12,    12,    12,    12,    12,    16,    26,    13,    20,
      19,    19,    19,    19,    19,    17,    27,    27,    13,    20,
      21,    28,    29,    14,    18,    29
};
